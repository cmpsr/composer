...
exports.loadSnippet = void 0;

const loadSnippet = () => {
  // Create a queue, but don't obliterate an existing one!
  const analytics = window.analytics = window.analytics || []; // If the real analytics.js is already on the page return.

  if (analytics.initialize) return analytics; // If the snippet was invoked already show an error.
