...
console.log('\nBuilding analytics.js ...');

exec('rollup -c -f umd -o umd/analytics.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'development',
});

console.log('\nBuilding analytics.min.js ...');

exec('rollup -c -f umd -o umd/analytics.min.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'production',
});

const size = gzipSize.sync(
  fs.readFileSync('umd/analytics.min.js')
);
