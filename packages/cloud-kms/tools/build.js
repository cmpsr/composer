...
console.log('\nBuilding cloud-kms.js ...');

exec('rollup -c -f umd -o umd/cloud-kms.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'development',
});

console.log('\nBuilding cloud-kms.min.js ...');

exec('rollup -c -f umd -o umd/cloud-kms.min.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'production',
});

const size = gzipSize.sync(
  fs.readFileSync('umd/cloud-kms.min.js')
);
