...
console.log('\nBuilding cloud-storage.js ...');

exec('rollup -c -f umd -o umd/cloud-storage.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'development',
});

console.log('\nBuilding cloud-storage.min.js ...');

exec('rollup -c -f umd -o umd/cloud-storage.min.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'production',
});

const size = gzipSize.sync(
  fs.readFileSync('umd/cloud-storage.min.js')
);
