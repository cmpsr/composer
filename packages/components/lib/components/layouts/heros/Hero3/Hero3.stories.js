...
const withText = () => /*#__PURE__*/_react.default.createElement(_.Hero3, {
...
const withPrimaryButtonLinkContent = () => /*#__PURE__*/_react.default.createElement(_.Hero3, {
  title: "Create an Out-of-this-World website with this headline",
  subtitle: "We are right now on the verge of finding out whether there is life elsewhere in the universe, and there are three ways we could find it.",
  style: {}
...
const withSecondaryButtonLinkContent = () => /*#__PURE__*/_react.default.createElement(_.Hero3, {
  title: "Create an Out-of-this-World website with this headline",
  subtitle: "We are right now on the verge of finding out whether there is life elsewhere in the universe, and there are three ways we could find it.",
  style: {}
}, /*#__PURE__*/_react.default.createElement(_primitives.Link, {
...
const withPrimarySecondaryButtonLinkContent = () => /*#__PURE__*/_react.default.createElement(_.Hero3, {
  title: "Create an Out-of-this-World website with this headline",
  subtitle: "We are right now on the verge of finding out whether there is life elsewhere in the universe, and there are three ways we could find it.",
  style: {}
...
const withTextAndDesktopImage = () => /*#__PURE__*/_react.default.createElement(_.Hero3, {
  title: "Create an Out-of-this-World website with this headline",
  subtitle: "We are right now on the verge of finding out whether there is life elsewhere in the universe, and there are three ways we could find it.",
  desktopAsset: {
    contentType: 'image',
...
const withTextDesktopAndMobileImage = () => /*#__PURE__*/_react.default.createElement(_.Hero3, {
  title: "Create an Out-of-this-World website with this headline",
  subtitle: "We are right now on the verge of finding out whether there is life elsewhere in the universe, and there are three ways we could find it.",
  desktopAsset: {
    contentType: 'image',
