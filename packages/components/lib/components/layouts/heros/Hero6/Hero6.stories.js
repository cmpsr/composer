...
var _default = {
  title: 'Composer/Layout/Hero/Hero6',
  component: _.Hero6
};
exports.default = _default;

const withText = () => /*#__PURE__*/_react.default.createElement(_.Hero6, {
...
const withPrimaryButtonLinkContent = () => /*#__PURE__*/_react.default.createElement(_.Hero6, {
  title: "Create an Out-of-this-World website with this headline",
  subtitle: "We are right now on the verge of finding out whether there is life elsewhere in the universe, and there are three ways we could find it.",
  eyebrow: "Space headline",
  style: {}
...
const withSecondaryButtonLinkContent = () => /*#__PURE__*/_react.default.createElement(_.Hero6, {
  title: "Create an Out-of-this-World website with this headline",
  subtitle: "We are right now on the verge of finding out whether there is life elsewhere in the universe, and there are three ways we could find it.",
  eyebrow: "Space headline",
  style: {}
...
const withPrimarySecondaryButtonLinkContent = () => /*#__PURE__*/_react.default.createElement(_.Hero6, {
  title: "Create an Out-of-this-World website with this headline",
  subtitle: "We are right now on the verge of finding out whether there is life elsewhere in the universe, and there are three ways we could find it.",
  eyebrow: "Space headline",
  style: {}
...
const withTextAndDesktopImage = () => /*#__PURE__*/_react.default.createElement(_.Hero6, {
  title: "Create an Out-of-this-World website with this headline",
  subtitle: "We are right now on the verge of finding out whether there is life elsewhere in the universe, and there are three ways we could find it.",
  eyebrow: "Space headline",
  desktopAsset: {
...
const withTextDesktopAndMobileImage = () => /*#__PURE__*/_react.default.createElement(_.Hero6, {
  title: "Create an Out-of-this-World website with this headline",
  subtitle: "We are right now on the verge of finding out whether there is life elsewhere in the universe, and there are three ways we could find it.",
  eyebrow: "Space headline",
  desktopAsset: {
