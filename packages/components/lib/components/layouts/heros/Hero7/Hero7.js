...
const Hero7 = ({
  ...
  return /*#__PURE__*/_react.default.createElement(_containers.Box, {
    size: "screen",
    className: (0, _classnames.default)("flex justify-start", className, colorClasses)
  }, mobileAsset && /*#__PURE__*/_react.default.createElement("div", {
    className: "md:hidden w-3/12 h-screen z-0 absolute"
    ...
    autoPlay: true,
    asset: desktopAsset,
    className: "hidden md:block object-cover w-7/12 h-full z-0 absolute",
    ...
    className: "relative z-10 max-w-hero-copy-medium text-right md:text-left"
    ...
    className: "flex justify-end md:justify-start mt-8"
  }, children)))));
};
