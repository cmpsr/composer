...
const getDropdownSingleSelectClasses = (disabled = false, invalid = false, itemSelected) => ({
  ...
  selectDisabledClasses: disabled ? 'bg-fill-form-disabled border-outline-form-disabled !text-outline-form-filled' : 'border-outline-form-filled hover:border-state-primary-enabled',
