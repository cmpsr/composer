      ...
      <Box size="full" className="flex justify-center items-center p-8">
        <Box size="content" className="flex justify-end items-center">
          <div className="relative z-10 max-w-hero-copy text-right">
            ...
            <div className="flex justify-end items-center mt-8">{children}</div>
          </div>
        </Box>
      </Box>
    </Box>
