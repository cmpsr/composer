...
export const Hero8 = ({
  ...
  return (
    <Box size="screen" className={cn("", className, colorClasses)}>
      {mobileAsset && (
        <div className="md:hidden w-screen h-screen z-0 absolute">
          <Asset
            autoPlay
            asset={mobileAsset}
      ...
      <Box size="full" className="flex justify-center items-center p-8">
        <Box size="content" className="flex justify-center items-center">
          <div className="relative z-10 max-w-hero-copy text-center">
            {eyebrow && (
              <Typography
                tag="h4"
