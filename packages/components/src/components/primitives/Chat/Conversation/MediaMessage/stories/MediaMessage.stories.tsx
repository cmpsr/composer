  ...
  <div className="p-10">
    <MediaMessage
      ...
      borderColor={select(
        ...
        MediaMessageBorderColor.Secondary25
      )}
      ...
      image={{
        ...
        url: text(
          'Url',
          'https://images.ctfassets.net/o9153kt66j4s/2ClCasVvBEEKCAnWbctHQt/195c416b76203751ad8d62f231e84855/Screen_Shot_2020-07-30_at_2.07.47_PM.png'
        ),
      }}
