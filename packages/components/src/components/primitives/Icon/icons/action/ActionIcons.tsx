...
export const _3d_rotation = ({ type }: Props) => {
  const iconType =
    type === 'filled' || type === 'outlined' || type === 'rounded';
...
export const account_balance_wallet = ({ type }: Props) => {
  ...
  return (
    <>
      <path d={path[type]} />
      {type === 'outlined' && <circle cx="16" cy="12" r="1.5" />}
    </>
  );
};
...
export const add_shopping_cart = ({ type }: Props) => {
  const iconType =
    type === 'filled' || type === 'outlined' || type === 'rounded';
...
export const camera_enhance = ({ type }: Props) => {
  ...
  return (
    <>
      ...
      {type === 'filled' && <path d={secondaryPath[type]} />}
    </>
  );
};
