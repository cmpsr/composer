...
export const check_box = ({ type }: Props) => {
  const path = {
    ...
    rounded:
      'M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-8.29 13.29c-.39.39-1.02.39-1.41 0L5.71 12.7a.9959.9959 0 010-1.41c.39-.39 1.02-.39 1.41 0L10 14.17l6.88-6.88c.39-.39 1.02-.39 1.41 0 .39.39.39 1.02 0 1.41l-7.58 7.59z',
  };

  return <path d={path[type]} />;
};

export const check_box_outline_blank = ({ type }: Props) => {
  const path = {
    filled:
...
export const indeterminate_check_box = ({ type }: Props) => {
  const path = {
    filled:
...
export const radio_button_checked = ({ type }: Props) => {
  const path = {
    filled:
...
export const radio_button_unchecked = ({ type }: Props) => {
  const path = {
    filled:
      'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z',
    outlined:
...
export const star = ({ type }: Props) => {
  const path = {
    ...
    rounded:
      'M12 17.27l4.15 2.51c.76.46 1.69-.22 1.49-1.08l-1.1-4.72 3.67-3.18c.67-.58.31-1.68-.57-1.75l-4.83-.41-1.89-4.46c-.34-.81-1.5-.81-1.84 0L9.19 8.63l-4.83.41c-.88.07-1.24 1.17-.57 1.75l3.67 3.18-1.1 4.72c-.2.86.73 1.54 1.49 1.08l4.15-2.5z',
  };

  return <path d={path[type]} />;
};

export const star_border = ({ type }: Props) => {
  const path = {
    filled:
...
export const star_half = ({ type }: Props) => {
  const path = {
    filled:
...
export const toggle_off = ({ type }: Props) => {
  const path = {
    filled:
...
export const toggle_on = ({ type }: Props) => {
  const path = {
    filled:
