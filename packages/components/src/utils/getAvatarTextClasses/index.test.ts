...
describe('getAvatarTextClasses', () => {
  ...
  it('should return string of classnames for primary-900 background color', () => {
  ...
  it('should return string of classnames for primary-600 background color', () => {
    const { avatarClasses } = getAvatarTextClasses(
      AvatarSize.Small,
      AvatarBackgroundColor.Primary600
    );
