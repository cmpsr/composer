...
console.log('\nBuilding contentful-core.js ...');

exec('rollup -c -f umd -o umd/contentful-core.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'development',
});

console.log('\nBuilding contentful-core.min.js ...');

exec('rollup -c -f umd -o umd/contentful-core.min.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'production',
});

const size = gzipSize.sync(
  fs.readFileSync('umd/contentful-core.min.js')
);
