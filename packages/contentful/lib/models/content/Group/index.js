...
const Group = /*#__PURE__*/_react.default.memo(props => {
  ...
  const componentMap = {
    [_constants.DEFAULT]: () => /*#__PURE__*/_react.default.createElement(_layouts.Group, groupProps, contentCollection.items.map((item, index) => /*#__PURE__*/_react.default.createElement("div", {
      key: index
    }, (0, _renderFromContentfulModel.default)(contentfulContext, item, index, id))))
  };
