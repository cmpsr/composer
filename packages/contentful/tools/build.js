...
console.log('\nBuilding contentful.js ...');

exec('rollup -c -f umd -o umd/contentful.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'development',
});

console.log('\nBuilding contentful.min.js ...');

exec('rollup -c -f umd -o umd/contentful.min.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'production',
});

const size = gzipSize.sync(
  fs.readFileSync('umd/contentful.min.js')
);
