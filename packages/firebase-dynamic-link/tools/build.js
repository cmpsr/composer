...
console.log('\nBuilding firebase-dynamic-link.js ...');

exec('rollup -c -f umd -o umd/firebase-dynamic-link.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'development',
});

console.log('\nBuilding firebase-dynamic-link.min.js ...');

exec('rollup -c -f umd -o umd/firebase-dynamic-link.min.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'production',
});

const size = gzipSize.sync(
  fs.readFileSync('umd/firebase-dynamic-link.min.js')
);
