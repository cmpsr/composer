...
console.log('\nBuilding firestore.js ...');

exec('rollup -c -f umd -o umd/firestore.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'development',
});

console.log('\nBuilding firestore.min.js ...');

exec('rollup -c -f umd -o umd/firestore.min.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'production',
});

const size = gzipSize.sync(
  fs.readFileSync('umd/firestore.min.js')
);
