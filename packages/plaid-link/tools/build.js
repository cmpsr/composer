...
console.log('\nBuilding plaid-link.js ...');

exec('rollup -c -f umd -o umd/plaid-link.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'development',
});

console.log('\nBuilding plaid-link.min.js ...');

exec('rollup -c -f umd -o umd/plaid-link.min.js', {
  BABEL_ENV: 'umd',
  NODE_ENV: 'production',
});

const size = gzipSize.sync(
  fs.readFileSync('umd/plaid-link.min.js')
);
